...
public class TeamEvalUI extends JFrame {
   ...
   private ResultSet myResultSet;
     ...
     */
    public TeamEvalUI(String databaseDriver, String databaseURL) {
      ...
      try
      {
         ...
         // connect to database
         myConnection = DriverManager.getConnection( databaseURL,"eval","eval" );
    ...
    private void loadTeams()
    {
      ...
      try
      {
          ...
          myResultSet = myStatement.executeQuery( "SELECT DISTINCT TEAMNAME FROM EVAL.TEAMS");
    ...
    private void updateTeams()
   {
      ...
      try
      {
         ...
         // String sql = "UPDATE EVAL.TEAMS SET Q1 = " + q1 + "," + "Q2 = " + q2  + "Q3 = " + q3+ " WHERE " +
            //           "TEAMNAME = '"+teamname+"'";
          String sql = "UPDATE EVAL.TEAMS SET Q1 = " + q1 + "," + "Q2 = " + q2+ ","  +"Q3="+ q3+ "," +"Q4 = " + q4 + ","  + "AVGSCORE = " + teamavg+ ","  +"COMMENTS = '" + comments + "' WHERE " +
                       "TEAMNAME = '"+teamname+"'";
    ...
    private void calculateavgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculateavgActionPerformed
        // TODO add your handling code here:
        teamavg=calculateAverage();
        averagefield.setText(""+teamavg);
        submit.setEnabled(true);
    }//GEN-LAST:event_calculateavgActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeamEvalUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeamEvalUI(databaseDriver, databaseURL).setVisible(true);
            }
        });
    }
